...
Interactive console sessions show a subdued green ASCII banner ordered as `Exposure DNA :: v0.5.2`, `Developer: IsdarlinM`, then the concise purpose statement. The banner is written to interactive stderr, keeping stdout suitable for JSON, graph exports, redirection, and automation.
